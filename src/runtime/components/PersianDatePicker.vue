...
:root
{
    ...
    --clear-color: #7f8c8d;
    --clear-color-hover: #e74c3c;
    --popup-bg: #fff;
    --popup-border: #e0e0e0;
    --popup-shadow: rgba(0, 0, 0, 0.15);
    --nav-btn-bg: #f5f5f5;
    --nav-btn-bg-hover: #e0e0e0;
    --nav-btn-text: #333;
    --year-month-text: #2c3e50;
    --quick-btn-bg: #3498db;
    --quick-btn-bg-hover: #2980b9;
    --quick-btn-text: #fff;
    --day-name-text: #7f8c8d;
    --day-name-bg: transparent;
    --day-bg: transparent;
    --day-text: #333;
    --day-bg-hover: #f5f5f5;
    --today-bg: #e8f0fe;
...
.quick-btn:hover
{
    background: var(--quick-btn-bg-hover);
}
